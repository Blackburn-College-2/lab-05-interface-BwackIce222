 ...
 */
public class RollerSkates implements Travel {
private final double mph = 8.0;
...
/**
    ...
    /**
     * builds and returns a String to be printed out
     * @return 
     */
@Override
    public String toString(){
       ...
       double hp = this.move(distance*2);
        ...
        String travel = "Skating "+(int)(h*mph)+" miles\n";
        String time = "";
        String r = "Returning...\n";
        String dtime = "";
